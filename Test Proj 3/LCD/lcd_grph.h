...
unsigned char lcd_putChar_15x21(unsigned short x, unsigned short y, unsigned char ch);

void lcd_putString(unsigned short x, unsigned short y, unsigned char *pStr);

void lcd_putString_15x21(unsigned short x, unsigned short y, unsigned char *pStr);
